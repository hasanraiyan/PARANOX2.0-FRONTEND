      ...
      <div className="flex-1 container mx-auto px-6 py-8 relative z-10">
        ...
        >
          <Button
            ...
            variant="ghost"
            size="icon"
            className="mr-6 text-white/70 hover:text-primary transition-all duration-300 hover:bg-white/5 backdrop-blur-sm rounded-xl"
          >
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <Label htmlFor="phone" className="text-white font-semibold text-lg mb-3 block">
                  Phone Number
                </Label>
                <Input
                  id="phone"
              ...
              >
                <Button
                  ...
                  className="bg-gradient-to-r from-primary to-accent-password hover:from-primary/90 hover:to-accent-password/90 text-white text-lg py-4 px-8 rounded-2xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-primary/30"
                >
                  Update Profile
                </Button>
              </motion.div>
